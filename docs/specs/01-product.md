...
- **Day/night (fases 1–2):** `DayNightController` owns Sky + sun orbit + hemi/sun/moon + stars; HUD **Hora** scrub 0–24h. Sem PMREM/frame, sem `@takram/three-atmosphere`, sem FPS HOLD. Postes GLB acendem à noite (`nightFactor` + pool ≤6 PointLights). Bússola HUD (N/S/L/O) após Começar.
