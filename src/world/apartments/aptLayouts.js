...
/** Living / sala wall albedos (ambientCG CC0) — soft paints, wallpaper, linen, TV accents. */
export const LIVING_WALL_IDS = [
  'living_warm_white',
  'living_cream',
  'living_soft_white',
  'living_ivory',
  'living_chalk',
  'living_porcelain',
  'living_linen_plaster',
  'living_butter',
  'living_sage',
  'living_sky_blue',
  'living_blush_red',
  'living_terracotta_soft',
  'living_gloss_white',
  'living_aqua',
  'living_mint',
  'living_lemon',
  'living_charcoal',
  'living_pearl_grey',
  'living_wallpaper_chip',
  'living_wallpaper_chip2',
  'living_linen_white',
  'living_linen_wool',
  'living_weave_soft',
  'living_weave_cream',
...
/** Portuguese labels for living wall showroom / arena. */
export const LIVING_WALL_LABELS = {
  living_warm_white: 'Branco quente sala',
  living_cream: 'Creme liso',
  living_soft_white: 'Branco mate',
  living_ivory: 'Marfim',
  living_chalk: 'Giz / chalk',
  living_porcelain: 'Porcelana',
  living_linen_plaster: 'Gesso linho',
  living_butter: 'Amarelo manteiga',
  living_sage: 'Verde sálvia',
  living_sky_blue: 'Azul céu suave',
  living_blush_red: 'Vermelho blush',
  living_terracotta_soft: 'Terracota suave',
  living_gloss_white: 'Branco brilho (TV)',
  living_aqua: 'Aqua / ciano',
  living_mint: 'Menta',
  living_lemon: 'Limão suave',
  living_charcoal: 'Carvão (destaque TV)',
  living_pearl_grey: 'Cinza pérola',
  living_wallpaper_chip: 'Papel madeira chip',
  living_wallpaper_chip2: 'Papel madeira chip 2',
  living_linen_white: 'Linho branco',
  living_linen_wool: 'Linho lã',
  living_weave_soft: 'Trama suave',
  living_weave_cream: 'Trama creme',
  living_weave_sand: 'Trama areia',
  living_weave_mist: 'Trama névoa',
  living_weave_pale: 'Trama pálida',
  living_felt_grey: 'Feltro cinza',
  living_linen_sage: 'Linho sálvia',
  living_linen_aqua: 'Linho aqua',
  living_linen_blue: 'Linho azul',
  living_linen_blush: 'Linho blush',
  living_accent_charcoal: 'Couro carvão (TV)',
  living_accent_beige: 'Couro bege',
  living_accent_tan: 'Couro tan',
  living_accent_ivory: 'Couro marfim',
  living_paper_white: 'Papel branco textura',
  living_paper_kraft: 'Papel kraft suave'
};
